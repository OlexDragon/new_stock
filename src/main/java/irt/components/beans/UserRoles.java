...
public enum UserRoles implements GrantedAuthority{
    ...
    PRODUCTION				(32768		, "old role: 'CUSTOMER_ORDER'; Can edit CUSTOMER ORDERs"),
    FINALIZE				(65536		, "old role: 'SCHEMATIC_PART'; Can change schematic part(AutoCAD)."),
    ECO						(131072		, "old role: 'STOCK'; The User can create ESOs"),
    EDIT_PROFILE_PROPERTY	(262144		, "old role: 'EDIT_COMPANIES'; Can edit profile property value and save to the DB"),
